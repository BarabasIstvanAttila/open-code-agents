...
${QMD_CMD} collection add "${MEMORY_DIR}/builds" --name builds 2>/dev/null || echo "  Collection 'builds' may already exist — skipping"
...
echo "  memory/builds/     — per-task build records"
